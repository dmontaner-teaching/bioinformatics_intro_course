...
outfile="2015_04_27_local_blast_practical"   #name for the final HTML file (without extension)
shfile="2015_04_27_local_blast_practical"

## more parameters 
infile="local_blast_practical"
