...
outfile="2015_04_20_blast_practical_especies"   #name for the final HTML file (without extension)
shfile="2015_04_20_blast_practical_especies"

## more parameters 
infile="blast_practical_species"
